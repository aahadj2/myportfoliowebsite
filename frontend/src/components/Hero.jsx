...
const socialLinks = [
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/in/abdul-ahad-jawad-99a39624b/',
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
  ...
  return (
    <section className={styles.hero} id="hero">
      ...
      <div className={`container ${styles.content}`}>
        ...
        >
          Hey, I'm{' '}
          <span className={styles.name}>Ahad J</span>
          <br />
        ...
        >
          I build immersive, scalable web applications with modern tech stacks.
          Passionate about creating experiences that feel alive — from pixel-perfect UIs
